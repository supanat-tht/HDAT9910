...
```{r echo=TRUE}
head(vitals_hourly_24hr_minmax)
```
...
This dataset contains hourly measurement of laboratory tests. A large number of variables originally contained out-of-range values. For example, the minimum hemoglobin is `r min(labs_hourly_24hr$hemoglobin, na.rm=T)`, and the maximum hemoglobin is max(labs_hourly_24hr$hemoglobin, na.rm=T).
...
```{r eval=FALSE, all_plots include=FALSE, include=FALSE}
...
splots[[2]] <- ggsurvplot(survfit(Surv(los, icu_expire_flag_2) ~ admission_type_2, data=alldata_q2), 
              ...
              surv.median.line = 'hv',
              pval=TRUE,
              title = "Survival plot of ICU admissions stratified by types of admission")
...
splots[[3]] <- ggsurvplot(survfit(Surv(los, icu_expire_flag_2) ~ endotrachflag, data=alldata_q2), 
              ...
              surv.median.line = 'hv',
              pval=TRUE,
              title = "Survival plot of ICU admissions stratified by endotracheal intubation")
